...
def main( image_paths, sampled_ref, sampled_input):   
    ...
    image_names = pd.read_csv('training_dataset.csv')
    TrainingDict = [] 
        ...
        for i in range(0,500):
            ...
            for j in range(0,10):
                 ...
                 if(np.mean(filters.sobel(image_cut))>0.06 and M1 == 256 and N1==256 and M2 == 256 and N2==256 ):
                     ...
                     k=k+1
    writeCSV('TrainingDatasetClassification.csv',TrainingDict)

if __name__ == "__main__":
    folder_data = "./WSI/"
    preprocess_output_image ="TranslationDataset/Train/input/"
    preprocess_output_ref   ="TranslationDataset/Train/reference/"
